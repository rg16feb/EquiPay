...
public class ListAdapterScoreByExpense extends ArrayAdapter<PayerDetails> {
    public ListAdapterScoreByExpense(Context context, ArrayList<PayerDetails> payerDetailsArrayList){
